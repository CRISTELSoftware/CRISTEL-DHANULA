...
namespace TMT_2012
{
    public partial class other_qty : Form
    {
        ...
        {
            lbl_itemNo.Text = other_catagory_data.itemno;
            lbl_itemName.Text = other_catagory_data.itemname;
            lbl_itemCat.Text = other_catagory_data.catagory;
            lbl_AvailableQty.Text = other_catagory_data.AvailableQty;
            lbl_itemCat.Text = other_catagory_data.catagory;
            lbl_current_prize.Text = other_catagory_data.unitPrice;
        ...
        {
            other_catagory_data.qty = txt_qty.Text;

            other_catagory_data.newPrice = txt_price.Text;

           // other_catagory_data.unitPrice = item_price.ToString();

            other_catagory_data.statusPass2Forms = true;
