...
namespace TMT_2012
{
    ...
    public partial class qty : Form
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="qty"/> class.
        /// </summary>
        public qty()
        {
            InitializeComponent();
        ...
        public void price_grid_fill()
        {
            ...
            string q = "SELECT price AS Price_Rs,last_update AS Last_Update FROM price WHERE category_id = " + catagory_id + "";
        ...
        private void radButton2_Click(object sender, EventArgs e)
        {
              ...
              //  vehical_category_data.newPrice = txt_price.Text;
                ...
                vehical_category_data.statusPass2Forms = true;
                    ...
                    else if (txt_qty.Text == "" ||Convert.ToInt32(txt_qty.Text) == 0)
                    {
                    ...
                    else
                    {
                        ...
                        string q0 = "SELECT * FROM add_vehical_tyre WHERE t_stok_id =" + cat_id + "";
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Are you sure you want to add stock?", "Information", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                else
                {
                    ...
                    int new_qty = Convert.ToInt32(row_available_qty.ItemArray.GetValue(9).ToString()) + Convert.ToInt32(txt_qty.Text);
                    ...
                    if (ds_qty_table != null)
                    {
                        ...
                        string q1 = "INSERT INTO qty VALUES(" + cat_id + "," + Convert.ToInt32(lbl_Aq.Text) + ",'" + action + "'," + Convert.ToInt32(txt_qty.Text) + ",'" + date + "','" + time + "')";
                        bool status = middle_access.db_access.InsertData(q1);
                        if (status == true)
                        {
                            string q = "UPDATE add_vehical_tyre SET qty = " + new_qty + "  WHERE t_stok_id = " + cat_id + " ";
                            middle_access.db_access.UpdateData(q);
                            ...
                            txt_qty.Text = "";
                            TyreSection s = new TyreSection();
                            s.radGridView1.Refresh();
                            s.set_total_qty();
                            s.fill_advance_search_table();
                        }
                        else
                        {
                            MessageBox.Show("Error!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (status == true)
                            {
                                string q2 = "UPDATE add_vehical_tyre SET qty = " + new_qty + "  WHERE t_stok_id = " + cat_id + " ";
